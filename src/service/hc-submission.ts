...
export async function createCompleteRecord(formData: CompleteFormData): Promise<void> {
    const records = formData.raidTypes.flatMap((raid) => formData.characterIds.map((character) => ({

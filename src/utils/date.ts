...
import { getYear, getMonth, getDate, getHours, subDays, addDays, format, startOfWeek, subWeeks, endOfWeek, formatDate, subMonths, endOfMonth, startOfMonth } from 'date-fns';
...
export function getLast6Weeks() {
    const weeks: { label: string; startDate: string; endDate: string; value: string }[] = [];
    const today = getServerToday();
